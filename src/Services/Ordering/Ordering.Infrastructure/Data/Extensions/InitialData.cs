...
namespace Ordering.Infrastructure.Data.Extensions
{
    internal class InitialData
    {
        public static IEnumerable<Customer> Customers =>
            [
                Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "dvali", "dvali@gmail.com"),
                Customer.Create(CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")), "lasha", "lasha@gmail.com")
            ];
        ...
        public static IEnumerable<Order> OrdersWithItems
        {
            get
            {
                var address1 = Address.Of("david", "dvali", "dvali@gmail.com", "Varketili No:4", "Georgia", "Tbilisi", "38050");
                var address2 = Address.Of("lasha", "dvali", "lasha@gmail.com", "Varketili No:1", "Georgia", "Tbilisi", "08050");

                var payment1 = Payment.Of("daviti", "5555555555554444", "12/28", "355", 1);
                var payment2 = Payment.Of("datoia", "8885555555554444", "06/30", "222", 2);
